class ClienteController {
    ...
    constructor() {
        this.inputNome =
            <HTMLInputElement>document.querySelector("#nome") // colocar cliente
        this.inputCPF =
            <HTMLInputElement>document.querySelector("#cpf") // colocar cliente
        this.inputNumero =
            <HTMLInputElement>document.querySelector("#numeroConta") // colocar cliente
        this.inputSaldo=
